...
#include "Brute_GuardCharacter.generated.h"

class AMM_PatrolPoints;
class AMM_AlarmSystem;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnTakeDownSignatureB, AActor*, Guard);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnHearPawnB, APawn*, PlayerPawn, FVector, Location, float, NoiseVolume);

UCLASS()
class MONSIEURMONET_API ABrute_GuardCharacter : public ACharacter
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	ABrute_GuardCharacter();

	UPROPERTY(BlueprintAssignable)
		FOnTakeDownSignatureB OnTakeDown;

	UPROPERTY(BlueprintAssignable)
		FOnHearPawnB OnHearPawn;
...
public:
	...
	UPROPERTY(BlueprintReadWrite)
		TSubclassOf<ABrute_GuardCharacter> BruteGuard;
